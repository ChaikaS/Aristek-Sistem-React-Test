import { ADD_ITEM, COMPLETED_ITEM, UPDATE_TODO_TEXT, SAVE_UPDATE_INPUT_TEXT, DELETED_ITEM, POST_ITEM_TO_TODO_LIST } from "../actions/actionsTodo";
...
export default function todoTasks(state = initialState.todoTasks, action) {
  ...
  switch (action.type) {
    ...
    //   const { text, id, edit } = action.payload;
